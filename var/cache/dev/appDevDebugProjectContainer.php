...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_5b473b568a2ec90af9cde965006ac41bfc7c7876ce880b7638d7fff53fdb3a96' => 'get15b473b568a2ec90af9cde965006ac41bfc7c7876ce880b7638d7fff53fdb3a96Service',
            '2_5b473b568a2ec90af9cde965006ac41bfc7c7876ce880b7638d7fff53fdb3a96' => 'get25b473b568a2ec90af9cde965006ac41bfc7c7876ce880b7638d7fff53fdb3a96Service',
            ...
            'datatable.doctrine_builder' => 'getDatatable_DoctrineBuilderService',
            'datatable.kernel.listener.terminate' => 'getDatatable_Kernel_Listener_TerminateService',
            'datatable.renderer' => 'getDatatable_RendererService',
        ...
        $this->privates = array(
            '1_5b473b568a2ec90af9cde965006ac41bfc7c7876ce880b7638d7fff53fdb3a96' => true,
            '2_5b473b568a2ec90af9cde965006ac41bfc7c7876ce880b7638d7fff53fdb3a96' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_5b473b568a2ec90af9cde965006ac41bfc7c7876ce880b7638d7fff53fdb3a96']) ? $this->services['1_5b473b568a2ec90af9cde965006ac41bfc7c7876ce880b7638d7fff53fdb3a96'] : $this->get15b473b568a2ec90af9cde965006ac41bfc7c7876ce880b7638d7fff53fdb3a96Service()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_5b473b568a2ec90af9cde965006ac41bfc7c7876ce880b7638d7fff53fdb3a96']) ? $this->services['2_5b473b568a2ec90af9cde965006ac41bfc7c7876ce880b7638d7fff53fdb3a96'] : $this->get25b473b568a2ec90af9cde965006ac41bfc7c7876ce880b7638d7fff53fdb3a96Service()) && false ?: '_'};
        }, 2));
    }
     ...
     *
     * @return \Waldo\DatatableBundle\Util\Datatable A Waldo\DatatableBundle\Util\Datatable instance
     */
    protected function getDatatableService()
    {
        ...
        return new \Waldo\DatatableBundle\Util\Datatable($a, $b, new \Waldo\DatatableBundle\Util\Factory\Query\DoctrineBuilder($a, $b), new \Waldo\DatatableBundle\Util\Formatter\Renderer(${($_ = isset($this->services['templating']) ? $this->services['templating'] : $this->get('templating')) && false ?: '_'}), array('all' => array('search' => false, 'action' => true), 'js' => array('jQueryUI' => 'false', 'pagingType' => 'full_numbers', 'lengthMenu' => array(0 => array(0 => 5, 1 => 10, 2 => 25, 3 => 50, 4 => -1), 1 => array(0 => 5, 1 => 10, 2 => 25, 3 => 50, 4 => 'All')), 'pageLength' => '10', 'serverSide' => true, 'processing' => true, 'paging' => true, 'lengthChange' => true, 'ordering' => true, 'searching' => true, 'autoWidth' => false, 'order' => array(), 'dom' => '<"clearfix"lf>rtip')));
    }

    /**
     * Gets the 'datatable.doctrine_builder' service.
     *
     * @return \Waldo\DatatableBundle\Util\Factory\Query\DoctrineBuilder A Waldo\DatatableBundle\Util\Factory\Query\DoctrineBuilder instance
     */
    protected function getDatatable_DoctrineBuilderService()
    {
        return new \Waldo\DatatableBundle\Util\Factory\Query\DoctrineBuilder(${($_ = isset($this->services['doctrine.orm.default_entity_manager']) ? $this->services['doctrine.orm.default_entity_manager'] : $this->get('doctrine.orm.default_entity_manager')) && false ?: '_'}, ${($_ = isset($this->services['request_stack']) ? $this->services['request_stack'] : $this->get('request_stack')) && false ?: '_'});
    }

    /**
     * Gets the 'datatable.kernel.listener.terminate' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Waldo\DatatableBundle\Listener\KernelTerminateListener A Waldo\DatatableBundle\Listener\KernelTerminateListener instance
     */
    protected function getDatatable_Kernel_Listener_TerminateService()
    {
        return $this->services['datatable.kernel.listener.terminate'] = new \Waldo\DatatableBundle\Listener\KernelTerminateListener($this);
    }

    /**
     * Gets the 'datatable.renderer' service.
     *
     * @return \Waldo\DatatableBundle\Util\Formatter\Renderer A Waldo\DatatableBundle\Util\Formatter\Renderer instance
     */
    protected function getDatatable_RendererService()
    {
        return new \Waldo\DatatableBundle\Util\Formatter\Renderer(${($_ = isset($this->services['templating']) ? $this->services['templating'] : $this->get('templating')) && false ?: '_'});
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Waldo\DatatableBundle\Twig\Extension\DatatableExtension A Waldo\DatatableBundle\Twig\Extension\DatatableExtension instance
     */
    protected function getDatatable_Twig_ExtensionService()
    {
        return $this->services['datatable.twig.extension'] = new \Waldo\DatatableBundle\Twig\Extension\DatatableExtension(${($_ = isset($this->services['translator']) ? $this->services['translator'] : $this->get('translator')) && false ?: '_'});
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListener('kernel.terminate', array(0 => function () {
            return ${($_ = isset($this->services['datatable.kernel.listener.terminate']) ? $this->services['datatable.kernel.listener.terminate'] : $this->get('datatable.kernel.listener.terminate')) && false ?: '_'};
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_54a97286fe85163a5b798ac4e7383aa14331f73df49c3f62a8e86035bb65de88');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(${($_ = isset($this->services['datatable.twig.extension']) ? $this->services['datatable.twig.extension'] : $this->get('datatable.twig.extension')) && false ?: '_'});
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/waldo/datatable-bundle/Resources/views'), 'WaldoDatatable');
    ...
    /**
     * Gets the '1_5b473b568a2ec90af9cde965006ac41bfc7c7876ce880b7638d7fff53fdb3a96' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get15b473b568a2ec90af9cde965006ac41bfc7c7876ce880b7638d7fff53fdb3a96Service()
    {
        return $this->services['1_5b473b568a2ec90af9cde965006ac41bfc7c7876ce880b7638d7fff53fdb3a96'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the '2_5b473b568a2ec90af9cde965006ac41bfc7c7876ce880b7638d7fff53fdb3a96' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get25b473b568a2ec90af9cde965006ac41bfc7c7876ce880b7638d7fff53fdb3a96Service()
    {
        return $this->services['2_5b473b568a2ec90af9cde965006ac41bfc7c7876ce880b7638d7fff53fdb3a96'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('5XC7NM4Dg8', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Y6ySSrTEpN', 0, 'MlCimob7QBAgq316YuNrr7', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8hN8m548Uu', 0, 'MlCimob7QBAgq316YuNrr7', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zMtfTtcdAV', 0, 'MlCimob7QBAgq316YuNrr7', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a966d1d7fcd95.59903732');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'WaldoDatatableBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/waldo/datatable-bundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'WaldoDatatableBundle' => 'Waldo\\DatatableBundle\\WaldoDatatableBundle',
