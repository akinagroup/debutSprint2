 ...
 */
class Reservation extends \Akina\ImmobilierBundle\Entity\Reservation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Akina\\ImmobilierBundle\\Entity\\Reservation' . "\0" . 'id', '' . "\0" . 'Akina\\ImmobilierBundle\\Entity\\Reservation' . "\0" . 'dateDeReservation', '' . "\0" . 'Akina\\ImmobilierBundle\\Entity\\Reservation' . "\0" . 'etat', '' . "\0" . 'Akina\\ImmobilierBundle\\Entity\\Reservation' . "\0" . 'Client', '' . "\0" . 'Akina\\ImmobilierBundle\\Entity\\Reservation' . "\0" . 'Bien'];
        }
    ...
    public function setClientI($client)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setClientI', [$client]);

        return parent::setClientI($client);
    }
    ...
    public function setBienI($bien)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBienI', [$bien]);

        return parent::setBienI($bien);
    }
